...
// Self-contained generator for beautiful, crisp, valid PWA app icons (Break the Skyline)
export function ensureIcons() {
  ...
  // 1. Write the vector SVG icon (scalable, crystal clear on retina/iPhone displays)
  ...
  <!-- Horizon Curved Glow (Representing Break-the-Skyline curvature of Earth) -->
  ...
  <!-- Jet Fighter Silhouette (Sleek, silver-white futuristic model) -->
  <g fill="url(#jetGrad)" filter="drop-shadow(0px 8px 16px rgba(0,0,0,0.65))">
    ...
    <!-- Left Tail Fin Stabilizer -->
    <path d="M 251 285 
             L 216 325 
             L 219 335 
             L 250 318 Z" />

    <!-- Right Tail Fin Stabilizer -->
    <path d="M 261 285 
             L 296 325 
             L 293 335 
             L 262 318 Z" />
             
    <!-- Twin Engine Exhausts Glow spots -->
...
`;
  ...
  // 2. Base64 encoded minimum valid 192x192 and 512x512 fallback PNGs.
  // When native canvas is not easy to render in headless node without complex dependencies, 
  // writing a robust base64 PNG template is beautiful, lightweight and avoids broken standard image errors.
